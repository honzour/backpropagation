...
<HEAD>
<META charset="utf-8">
<TITLE>Backpropagation - Export to XML</TITLE>
</HEAD>
<BODY>
<?
include 'google.php'
...
<P>
XML is a text format, so saved data can be opened in any text editor and it is quite well human readable for small networks. If you want save just the network anatomy and training set and not each weight (training status), use CSV file format.
</P>
<PRE>
